...
//            insertCell(table, "New York Orders ...", Element.ALIGN_LEFT, 7, sarabunB);
            ...
            for (int x = 0; x < logList.size(); x++) {
                ...
                String working = getAction(bean.getAction());
...
//                String idTable = custom.get("idTable");
                ...
                String valBefore = String.valueOf(bean.getValBefore());
                ...
                String valAfter = String.valueOf(bean.getValAfter());
                ...
                insertCell(table, getNote(bean.getAction()), Element.ALIGN_CENTER, 1, sarabun14);
