...
public class RestApiNetPie {
    private static final String TAG = "RestApiNetPie";
    OkHttpClient client;
    String url;
    String appID;
    String appKey;
    ...
    public RestApiNetPie(String appID, String appKey, String appSecret){
        this.appID = appID;
        this.appKey = appKey;
    ...
    public SubscribeBean subscribe(String topic)  {
